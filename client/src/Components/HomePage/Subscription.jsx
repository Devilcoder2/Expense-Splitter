...
const Subscription = () => {
  ...
  return (
    <div ref={subRef} className="relative min-h-screen " id="sub">
      <div className="absolute inset-0 bg-white">
        <div className="bg-gradient-to-b from-pink-700 h-full w-full"></div>
        <div className="absolute inset-0 flex flex-col items-center justify-center -top-44 md:top-0 h-1/2 pb-40">
          <p className="text-4xl font-bold text-white">Subscription</p>
          <p className="text-center text-gray-200 max-w-md mt-4">
      ...
      <div className="relative z-10 flex justify-center items-center h-auto pt-36 ">
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 p-8">
          {/* Card 1 */}
          <div className={`max-w-xs ${isVisible ? "animate__animated animate__rotateInDownLeft" : ""}   bg-white rounded-lg shadow-lg p-6 text-center w-80 h-96`}>
          ...
          {/* Card 2 */}
          <div className={`max-w-xs ${isVisible ? "animate__animated animate__zoomIn" : ""} bg-white rounded-lg shadow-lg p-6 text-center w-80 h-96`}>
          ...
          {/* Card 3 */}
          <div className={`max-w-xs ${isVisible ? "animate__animated animate__rotateInDownRight" : ""} bg-white rounded-lg shadow-lg p-6 text-center w-80 h-96`}>
